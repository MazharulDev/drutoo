...
const cashinSchema = yup.object().shape({
  userNumber: yup.string().required("User mobile number is required"),
  amount: yup
    .number()
...
export default function CashinScreen() {
  ...
  const onSubmit = async (data: ICashinData) => {
    // TODO: Implement cash-in API
    console.log("Cash In Data:", data);
    Alert.alert("Success", "Cash-in successful!");
    reset();
  };
        ...
        <View style={styles.inputGroup}>
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <TextInput
                style={[styles.input, errors.userNumber && styles.inputError]}
          ...
          />
          {errors.userNumber && (
            <Text style={styles.errorText}>{errors.userNumber.message}</Text>
          )}
        </View>
