...
const cashout = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield session.withTransaction(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if ((receiver === null || receiver === void 0 ? void 0 : receiver.role) !== "agent" || (receiver === null || receiver === void 0 ? void 0 : receiver.status) === "inactive") {
                throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "This number is not an agent number");
            }
            if (!sender || !receiver) {
